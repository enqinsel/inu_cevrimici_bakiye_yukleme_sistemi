...
if(!$yemekvar) {
    ...
    ?>
    <div class="col-md-3">
        <div class="col-md-12 cerceve1"> <img src="img/bez.jpg" class="img-responsive" alt=""> </div>
    ...
    <div class="col-md-3">
        <div class="col-md-12 cerceve1">
            <img src="img/pil.jpg" class="img-responsive" alt="">
        </div>
        <div class="col-md-12 baslik1 mt-10 text-center">
            <?php echo $yemek2; ?>
        </div>
    ...
    <div class="col-md-3">
        <div class="col-md-12 cerceve1">
            <img src="img/sal.jpg" class="img-responsive" alt="">
        </div>
        <div class="col-md-12 baslik1 mt-10 text-center">
            <?php echo $yemek3; ?>
        </div>
    ...
    <div class="col-md-3">
        <div class="col-md-12 cerceve1">
            <img src="img/ay.jpg" class="img-responsive" alt="">
        </div>
        <div class="col-md-12 baslik1 mt-10 text-center">
            <?php echo $yemek4; ?>
        </div>
